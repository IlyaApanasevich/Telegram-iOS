...
1. The service for receiving time from the API is moved to a separate submodule DateFetchable
2. While the data from the api is not yet ready, the date of the earliest call is displayed
...
```
git clone --recursive -j8 https://github.com/IlyaApanasevich/Telegram-iOS.git
```
